...
import (
	...
	"github.com/tl-developer/goroute/simulator/internal"
)

func main() {
	// mongoURI := getEnv("MONGO_URI", "mongodb://root:root@mongodb:27017/gosimulator?authSource=admin&directConnection=true")
	mongoURI := getEnv("MONGO_URI", "mongodb://root:root@localhost:27017/gosimulator?authSource=admin&directConnection=true")
